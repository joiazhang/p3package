...
gdp_coeff <- lm["gdpPercap", "Estimate"]
gdp_p_val <- lm["gdpPercap", "Pr(>|t|)"]
...
for (i in 1:10) {
  ...
  missclassification_err_list[[i]] <- as.double(count(knn_list[[i]]$class == y)) / length(knn_list[[i]]$class)
