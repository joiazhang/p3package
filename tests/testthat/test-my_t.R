...
test_that("alternative = two.sided works", {
  expect_equal(my_t.test(my_gapminder$lifeExp, alternative = "two.sided", 60), list("test_stat" = -1.67954774, "df" = 1703, "alternative" = "two.sided", "p_val" = 0.09322877))
  expect_equal(my_t.test(x = my_gapminder$lifeExp, mu = 60), list("test_stat" = -1.67954774, "df" = 1703, "alternative" = "two.sided", "p_val" = 0.09322877))
})
